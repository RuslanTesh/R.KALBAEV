...
public class TraineeMap {
    ...
    public int getTraineesCount() { return map.size(); }
    ...
    public Set<Trainee> getAllTrainees() { return map.keySet(); }

    public Set<String> getAllInstitutes() { return new HashSet<>(map.values()); }
